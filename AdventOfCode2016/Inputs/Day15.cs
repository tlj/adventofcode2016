...
namespace AdventOfCode2016.Inputs
{
    public class Day15
    {
        public static string testData = @"Disc #1 has 5 positions; at time=0, it is at position 4.
Disc #2 has 2 positions; at time=0, it is at position 1.";

        public static string realData = @"Disc #1 has 13 positions; at time=0, it is at position 10.
